...
public class QuanLyKhuyenMaiModule extends JPanel implements AppModule {
    ...
    private JPanel buildHeader() {
        JPanel header = new JPanel(new BorderLayout(24, 0)) {
            @Override protected void paintComponent(Graphics g) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                GradientPaint gp = new GradientPaint(0, 0, NotionTheme.NAVY, getWidth(), getHeight(), new Color(0xE0, 0x31, 0x31));
                g2.setPaint(gp);
                g2.fillRoundRect(0, 0, getWidth(), getHeight(), 24, 24);
                g2.setColor(AppColors.withAlpha(NotionTheme.ROSE, 132));
                g2.fillOval(getWidth() - 204, 8, 150, 150);
                g2.setColor(AppColors.withAlpha(NotionTheme.PEACH, 112));
                g2.fillRoundRect(getWidth() - 330, 98, 170, 46, 24, 24);
                g2.setColor(AppColors.withAlpha(Color.WHITE, 42));
                g2.fillOval(getWidth() - 285, 34, 58, 58);
                g2.dispose();
        ...
        btnAddNew.setPreferredSize(new Dimension(160, 42));
    ...
    private class BadgeCellRenderer extends JPanel implements TableCellRenderer {
        ...
        BadgeCellRenderer() {
            ...
            // Handoff: badge trạng thái khuyến mãi bám gần full ô như tag dữ liệu trong table.
            // Nếu text trạng thái dài hơn, ưu tiên nới cột hoặc giảm BADGE_MARGIN_X.
        }
